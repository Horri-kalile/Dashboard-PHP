            ...
            <div class="main-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <?php 
                                 ...
                                 <?php 
                                    if (isset($_GET['resultatModif'])) {
                                        if($_GET['resultatModif']="ouiModif"){
                                            ...
                                            <div class="alert alert-success" role="alert">
                                              <strong>admin</strong> Modifier avec succes.
                                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                              </button>
                                            </div>
                                    ...
                                    ?>
                                     ...
                                     <?php 
                                    if (isset($_GET['resultat1'])) {
                                        if($_GET['resultat1']="ouiSupp"){
                                            ...
                                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                              <strong>Administrateur</strong> Supprimer avec succes.
                                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                              </button>
                                            </div>
                                                ...
                                                <table class="table table-striped table-nowrap align-middle mb-0">
                                                    ...
                                                    <?php
                                                      ...
                                                      while ($donnees = $req->fetch()) {
                                                          ...
                                                          ?>
                                                        <tr>
                                                            <td class="fw-medium"><?php echo $donnees['id_ad'] ?></td>
                                                            <td><img  style="width:50px; heigth:50px;" src="uploads/<?php echo $donnees['img_ad'] ?>"></td>
                                                            <td><?php echo $donnees['nom_ad'] ?></td>
                                                            <td><?php echo $donnees['pren_ad'] ?></td>
                                                            <td><?php echo $donnees['mail_ad'] ?></td>
                                                            <td>
                                                            <a href="modifieradmin.php?id=<?php echo $donnees['id_ad'] ?>">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © best way for the Job.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by Khalil Horri 
                                </div>
                            </div>
                        </div>
                    </div>
